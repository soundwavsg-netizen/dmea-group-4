...
const PLATFORMS = ['TikTok', 'Instagram', 'Xiaohongshu 小红书', 'YouTube', 'Lazada Review', 'Shopee Review', 'Sephora Review', 'Reddit', 'FB Group', 'Blog/Article', 'Face to Face', 'Other'];
const METHODS = ['User Interview', 'Contextual Inquiry', 'Fly on the wall', 'General Observation', 'Secondary Research', 'Others'];
              ...
              <div className="pb-4 pt-4 space-y-6">
                ...
                <label className="flex flex-col">
                  ...
                  <textarea
                    ...
                    className="flex w-full min-w-0 flex-1 resize-y overflow-hidden rounded-md text-[#1F1A1A] focus:outline-0 focus:ring-2 focus:ring-[#A62639] border border-[#E0AFA0] bg-white min-h-[100px] p-4 text-sm font-normal leading-normal"
                    placeholder="User prefers products with 'natural' finish. Tried 3 brands this year..."
