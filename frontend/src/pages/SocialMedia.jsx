          ...
          <Card>
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                <Button 
                  onClick={analyzeData} 
                  disabled={analyzing || rows.length === 0 || (!isSuperadmin && !canPerformAction('analyze_data'))}
                  className="bg-[#A62639] hover:bg-[#8a1f2d] disabled:opacity-50 disabled:cursor-not-allowed"
                  data-testid="analyze-data-button"
                >
                  {(!isSuperadmin && !canPerformAction('analyze_data')) ? <Lock className="w-4 h-4 mr-2" /> : <BarChart3 className="w-4 h-4 mr-2" />}
            ...
            <CardContent>
              {!analytics ? (
                ...
                <div className="space-y-8">
                  ...
                  {/* Post-Level Push/Fix/Drop Classification */}
                  {analytics.classification_summary && (
                    <Card className="border-[#A62639]">
                      <CardHeader className="bg-[#FAF7F5]">
                        <CardTitle className="text-[#A62639]">Post-Level Action Plan (Push/Fix/Drop)</CardTitle>
                        <CardDescription>AI-powered classification of individual posts based on engagement and sentiment</CardDescription>
                      </CardHeader>
                      <CardContent className="pt-6">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                          <p className="text-sm text-blue-800">
                            <strong>Insight:</strong> View detailed post lists and individual classifications in the <strong>Insight Summary</strong> tab or expand the <strong>Post-Level Performance</strong> section below.
                          </p>
                        </div>
                      </CardContent>
                    </Card>
                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 space-y-2">
                                  <div className="flex flex-wrap gap-2">
                                    ...
                                    <Badge variant="outline">{post.post_type}</Badge>
                                    <Badge className={
                                      post.sentiment?.toLowerCase().includes('pos') ? 'bg-green-600 text-white font-semibold' : 
                                      post.sentiment?.toLowerCase().includes('neg') ? 'bg-red-600 text-white font-semibold' :
